...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.environ['GOOGLE_OA2_KEY']
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.environ['GOOGLE_OA2_SECRET']

SOCIAL_AUTH_GOOGLE_OAUTH2_WHITELISTED_DOMAINS = os.environ['OWN_DOMAIN']
